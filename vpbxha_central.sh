...
echo -e "************************************************************"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'MariaDB Client'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA2224'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA3121'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA5403'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA5404-5405'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA21064'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA9929'" | awk 'NR==2')
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_rules WHERE firewall_service_id = $service_id"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_whitelist WHERE description = 'Server 1 IP'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_whitelist WHERE description = 'Server 2 IP'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'MariaDB Client'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA2224'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA3121'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA5403'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA5404-5405'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA21064'"
mysql -ucentral ombutel -e "DELETE FROM ombu_firewall_services WHERE name = 'HA9929'"
...
[embedded]
EOF
scp /etc/my.cnf.d/server.cnf central@$ip_standby:/etc/my.cnf.d/server.cnf
mysql -ucentral -e "STOP SLAVE;"
mysql -ucentral -e "RESET SLAVE;"
systemctl restart mariadb
ssh central@$ip_standby 'mysql -ucentral -e "STOP SLAVE;"'
ssh central@$ip_standby 'mysql -ucentral -e "RESET SLAVE;"'
ssh central@$ip_standby "systemctl restart mariadb"
...
--
EOF
scp /etc/lsyncd.conf central@$ip_standby:/etc/lsyncd.conf
...
systemctl stop pacemaker.service
EOF
scp /tmp/remotecluster.sh central@$ip_standby:/tmp/remotecluster.sh
ssh central@$ip_standby "chmod +x /tmp/remotecluster.sh"
ssh central@$ip_standby "/tmp/./remotecluster.sh"	
systemctl stop lsyncd
systemctl enable asterisk
systemctl restart asterisk
ssh central@$ip_standby "systemctl stop lsyncd"
ssh central@$ip_standby "systemctl enable asterisk"
ssh central@$ip_standby "systemctl restart asterisk"
echo -e "************************************************************"
...
firewall-cmd --reload
ssh central@$ip_standby "firewall-cmd --remove-service=high-availability"
ssh central@$ip_standby "firewall-cmd --zone=public --remove-port=3306/tcp"
ssh central@$ip_standby "firewall-cmd --runtime-to-permanent"
ssh central@$ip_standby "firewall-cmd --reload"
echo -e "************************************************************"
...
ssh central@$ip_standby "echo -e '$ip_master \t$host_master' >> /etc/hosts"
ssh central@$ip_standby "echo -e '$ip_standby \t$host_standby' >> /etc/hosts"
echo -e "*** Done Step 2 ***"
echo -e "2"	> step.txt
...
echo -e "************************************************************"
remote_tenant_id=`ssh central@$ip_standby "ls /var//lib/vitalpbx/static/"`
ssh central@$ip_standby "rm -rf /var/lib/vitalpbx/static/$remote_tenant_id"
echo -e "*** Done Step 3 ***"
echo -e "3"	> step.txt
...
firewall-cmd --reload
ssh central@$ip_standby "firewall-cmd --permanent --add-service=high-availability"
ssh central@$ip_standby "firewall-cmd --permanent --zone=public --add-port=3306/tcp"
ssh central@$ip_standby "firewall-cmd --reload"
...
echo -e "************************************************************"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('MariaDB Client', 'tcp', '3306')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA2224', 'tcp', '2224')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA3121', 'tcp', '3121')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA5403', 'tcp', '5403')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA5404-5405', 'udp', '5404-5405')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA21064', 'tcp', '21064')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_services (name, protocol, port) VALUES ('HA9929', 'both', '9929')"
echo -e "************************************************************"
echo -e "*             Configuring Permanent Firewall               *"
echo -e "*     Creating Firewall Rules in VitalPBX in Server 1      *"
echo -e "************************************************************"
last_index=$(mysql -ucentral ombutel -e "SELECT MAX(\`index\`) AS Consecutive FROM ombu_firewall_rules"  | awk 'NR==2')
last_index=$last_index+1
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'MariaDB Client'" | awk 'NR==2')
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_master', 'accept', $last_index)"
last_index=$last_index+1
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_standby', 'accept', $last_index)"
last_index=$last_index+1
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA2224'" | awk 'NR==2')
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_master', 'accept', $last_index)"
last_index=$last_index+1
...
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_master', 'accept', $last_index)"
last_index=$last_index+1
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_arbitrator', 'accept', $last_index)"
last_index=$last_index+1
service_id=$(mysql -ucentral ombutel -e "select firewall_service_id from ombu_firewall_services where name = 'HA9929'" | awk 'NR==2')
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_master', 'accept', $last_index)"
last_index=$last_index+1
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_rules (firewall_service_id, source, action, \`index\`) VALUES ($service_id, '$ip_standby', 'accept', $last_index)"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_whitelist (host, description, \`default\`) VALUES ('$ip_master', 'Server 1 IP', 'no')"
mysql -ucentral ombutel -e "INSERT INTO ombu_firewall_whitelist (host, description, \`default\`) VALUES ('$ip_standby', 'Server 2 IP', 'no')"
echo -e "*** Done Step 4 ***"
echo -e "4"	> step.txt
...
ssh central@$ip_standby [[ ! -d /var/spool/asterisk/monitor ]] && ssh central@$ip_standby "mkdir /var/spool/asterisk/monitor" || echo "Path exist";
ssh central@$ip_standby "chown -R asterisk:asterisk /var/spool/asterisk/monitor"

ssh central@$ip_standby [[ ! -d /usr/share/vitxi ]] && ssh central@$ip_standby "mkdir /usr/share/vitxi" || echo "Path exist";
ssh central@$ip_standby "chown -R apache:apache /usr/share/vitxi"

ssh central@$ip_standby [[ ! -d /usr/share/vitxi/backend ]] && ssh central@$ip_standby "mkdir /usr/share/vitxi/backend" || echo "Path exist";
ssh central@$ip_standby "chown -R apache:apache /usr/share/vitxi/backend"

ssh central@$ip_standby [[ ! -d /usr/share/vitxi/backend/storage ]] && ssh central@$ip_standby "mkdir /usr/share/vitxi/backend/storage" || echo "Path exist";
ssh central@$ip_standby "chown -R apache:apache /usr/share/vitxi/backend/storage"

ssh central@$ip_standby [[ ! -d /var/lib/vitxi ]] && ssh central@$ip_standby "mkdir /var/lib/vitxi" || echo "Path exist";
ssh central@$ip_standby "chown -R apache:apache /var/lib/vitxi"
...
EOF
scp /tmp/lsyncd.conf central@$ip_standby:/etc/lsyncd.conf
echo -e "*** Done Step 5 ***"
echo -e "5"	> step.txt
...
mysql -ucentral -e "DELETE FROM mysql.user WHERE User='';"
...
mysql -ucentral -e "GRANT REPLICATION SLAVE ON *.* to vitalpbx_replica@'%' IDENTIFIED BY 'vitalpbx_replica';"
mysql -ucentral -e "FLUSH PRIVILEGES;"
mysql -ucentral -e "FLUSH TABLES WITH READ LOCK;"
#Get bin_log on Master-1
file_server_1=`mysql -ucentral -e "show master status" | awk 'NR==2 {print $1}'`
position_server_1=`mysql -ucentral -e "show master status" | awk 'NR==2 {print $2}'`

#Now on the Master-1 server, do a dump of the database MySQL and import it to Master-2
mysqldump -u central --all-databases > all_databases.sql
scp all_databases.sql central@$ip_standby:/tmp/all_databases.sql
cat > /tmp/mysqldump.sh << EOF
#!/bin/bash
mysql mysql -u central <  /tmp/all_databases.sql 
EOF
scp /tmp/mysqldump.sh central@$ip_standby:/tmp/mysqldump.sh
ssh central@$ip_standby "chmod +x /tmp/mysqldump.sh"
ssh central@$ip_standby "/tmp/./mysqldump.sh"
...
max_allowed_packet = 64M
EOF
scp /tmp/vitalpbx.cnf central@$ip_standby:/etc/my.cnf.d/vitalpbx.cnf
ssh central@$ip_standby "systemctl restart mariadb"
...
mysql -ucentral -e "FLUSH TABLES WITH READ LOCK;"
EOF
scp /tmp/grand.sh central@$ip_standby:/tmp/grand.sh
ssh central@$ip_standby "chmod +x /tmp/grand.sh"
ssh central@$ip_standby "/tmp/./grand.sh"
#Get bin_log on Master-2
file_server_2=`ssh central@$ip_standby 'mysql -ucentral -e "show master status;"' | awk 'NR==2 {print $1}'`
position_server_2=`ssh central@$ip_standby 'mysql -ucentral -e "show master status;"' | awk 'NR==2 {print $2}'`
#Stop the slave, add Master-1 to the Master-2 and start slave
cat > /tmp/change.sh << EOF
#!/bin/bash
mysql -ucentral -e "STOP SLAVE;"
mysql -ucentral -e "CHANGE MASTER TO MASTER_HOST='$ip_master', MASTER_USER='vitalpbx_replica', MASTER_PASSWORD='vitalpbx_replica', MASTER_LOG_FILE='$file_server_1', MASTER_LOG_POS=$position_server_1;"
mysql -ucentral -e "START SLAVE;"
EOF
scp /tmp/change.sh central@$ip_standby:/tmp/change.sh
ssh central@$ip_standby "chmod +x /tmp/change.sh"
ssh central@$ip_standby "/tmp/./change.sh"

#Connect to Master-1 and follow the same steps
mysql -ucentral -e "STOP SLAVE;"
mysql -ucentral -e "CHANGE MASTER TO MASTER_HOST='$ip_standby', MASTER_USER='vitalpbx_replica', MASTER_PASSWORD='vitalpbx_replica', MASTER_LOG_FILE='$file_server_2', MASTER_LOG_POS=$position_server_2;"
mysql -ucentral -e "START SLAVE;"
...
ssh central@$ip_standby "echo $hapassword | passwd --stdin hacluster"
echo -e "*** Done Step 7 ***"
echo -e "7"	> step.txt
...
ssh central@$ip_standby "systemctl start pcsd"
systemctl enable pcsd.service 
systemctl enable corosync.service 
systemctl enable pacemaker.service
ssh central@$ip_standby "systemctl enable pcsd.service"
ssh central@$ip_standby "systemctl enable corosync.service"
ssh central@$ip_standby "systemctl enable pacemaker.service"
echo -e "*** Done Step 8 ***"
echo -e "8"	> step.txt
...
systemctl stop lsyncd
ssh central@$ip_standby "systemctl disable asterisk"
ssh central@$ip_standby "systemctl stop asterisk"
ssh central@$ip_standby "systemctl disable lsyncd"
ssh central@$ip_standby "systemctl stop lsyncd"
echo -e "*** Done Step 13 ***"
echo -e "13"	> step.txt
...
scp /usr/local/bin/bascul central@$ip_standby:/usr/local/bin/bascul
ssh central@$ip_standby 'chmod +x /usr/local/bin/bascul'
echo -e "*** Done Step 16 ***"
echo -e "16"	> step.txt
...
scp /usr/local/bin/role central@$ip_standby:/usr/local/bin/role
ssh central@$ip_standby 'chmod +x /usr/local/bin/role'
echo -e "*** Done Step 17 ***"
echo -e "17"	> step.txt
